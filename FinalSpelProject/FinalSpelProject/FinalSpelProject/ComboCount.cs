    ...
    struct ComboCounter
    {
        ...
        public void Update(List<Player> players)
        {
            foreach (Player p in players)
            {
                ...
                barLength = p.GetComboCount()*3;
                if(p.GetCurrentCombo() <= 0)
                {
                    barLength = 0;
                }
            }
        ...
        public void Draw(SpriteBatch spriteBatch, SpriteFont font, Texture2D spritesheet)
        {
            ...
            //spriteBatch.Draw(spritesheet, new Rectangle((int)pos.X, (int)pos.Y+26, (int)barLength, 8), new Rectangle(430, 1, 1, 8), Color.Orange);
        }
    }
}